		...
		case "enter":
			if screen.newTitle != "" &&
				...
				if screen.newItemData != nil {
					...
					resp, err := screen.itemManager.grpcClient.Handlers.BankCardsHandler.PostBankCardData(context.Background(),
						&pb.PostBankCardDataRequest{
							CardNum: screen.newItemData.cardNum,
							Expiry:  screen.newItemData.expiry,
							Cvv:     screen.newItemData.cvv,
							CardId:  screen.selectedItem.dataID,
							MetaData: &pb.MetaData{
